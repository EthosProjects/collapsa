        ...
        hit(){        
            if (this.punch.ready) {
                ...
                Entities.forEach(e => {
                    ...
                    if(e instanceof STree || e instanceof Stone || e instanceof Iron || e instanceof Gold || e instanceof Diamond || e instanceof Emerald || e instanceof Amethyst || e instanceof CarrotFarm){
        ...
        update:function(){
            ...
            Doors.list.forEach(door => {
                ...
                if(door.health <= 0) {
                    ...
                    if(globalDoors.find(d => d == door)) globalDoors.splice(globalDoors.findIndex(d => d== door), 1)
    ...
    class STree {
        constructor(x, y, baselen = 100){
            ...
            this.deathTimeout = setTimeout(() => {
                ...
                Entities.splice(Entities.findIndex(e => e.id === this.id), 1);
            }, 300000)
