...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        let person =
            ...
            message.guild.members.cache.find(member => member.displayName.includes(args[0])) ||
            message.guild.members.cache.find(member => member.user.username.includes(args[0])) ||
        ...
        const embed = new MessageEmbed()
            .setColor('#0x00FF17')
            .addField(
                `☁ **${person.displayName || person.username}** loves **${
