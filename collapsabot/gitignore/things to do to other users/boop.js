...
module.exports = {
  ...
  run: async (client, message, args, tools) => {
    boop = [
      "https://media.giphy.com/media/DSzhk81pkwTrW/giphy.gif",
      ...
      "https://media.giphy.com/media/13eFBWrZEnJTGM/giphy.gif",
      "https://media.giphy.com/media/1qgIPm9bmOhRjANGGF/giphy.gif",
      "https://media.giphy.com/media/1qgIPm9bmOhRjANGGF/giphy.gif",
      "",
    ];
    ...
    const embed = new Discord.MessageEmbed()
      .setColor("#0x00FF17")
      .setTitle(
        `${message.author.username} booped ${
