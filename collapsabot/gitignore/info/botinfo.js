...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .addField(
        "**Want more info?**",
        "[Check out our website](https://bit.ly/Duke_bot)",
        true
      )
      .addField(
        "**Having Problems?",
        "[Join the support server](https://discord.gg/wD2WEwh)",
        true
      )
      .addField(
        "**Liking the bot?**",
        "[Vote for Duke here](https://top.gg/bot/678124077654867978/vote)",
        true
      )
