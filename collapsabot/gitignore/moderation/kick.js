...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!toKick.kickable) {
            return message.reply("I can't Kick that person due to role hierarchy, I suppose. Ask a staff member to move my role above the role you are trying to Kick")
                .then(m => m.delete());
        }
