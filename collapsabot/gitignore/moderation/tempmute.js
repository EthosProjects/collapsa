...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (!message.member.hasPermission('MANAGE_MESSAGES'))
            return message.reply('You Do not have permission to mute. Please contact a staff member');
        ...
        const embed = new MessageEmbed()
            ...
            .setTimestamp().setDescription(stripIndents`**- Muted member:** ${toMute} (${toMute.id})
  ...
  **- Time:** ${args.slice(1).join(' ')}`);
        ...
        setTimeout(function () {
            ...
            const unmuteembed = new MessageEmbed()
                ...
                .setThumbnail(toMute.user.displayAvatarURL)
                .setFooter(message.member.displayName, message.author.displayAvatarURL)
                .setTimestamp().setDescription(stripIndents`**- Unmuted member:** ${toMute} (${toMute.id})
