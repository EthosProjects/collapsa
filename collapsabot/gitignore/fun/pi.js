...
module.exports = {
    ...
    const pibed = new Discord.MessageEmbed()
        .setThumbnail("https://cms.qz.com/wp-content/uploads/2018/03/pi-symbol.png?w=1400&strip=all&quality=75")
        ...
        .addField("~~~~~~~~~~~~~~~~~~~~~~~~", "7-9, then 3-2-3 OMG! Can't you see?")
        .addField("~~~~~~~~~~~~~~~~~~~~~~~~", "8-4-6-2-6-4-3 And now we're on a spree")
        .addField("~~~~~~~~~~~~~~~~~~~~~~~~", "38 and 32, now we're blue Oh, who knew?")
        ...
        .addField("~~~~~~~~~~~~~~~~~~~~~~~~", "We're almost near the end, keep going")
        .addField("~~~~~~~~~~~~~~~~~~~~~~~~", "62, we're getting through")
        .addField("~~~~~~~~~~~~~~~~~~~~~~~~", "0-8-9-9, on time")
        .addField("~~~~~~~~~~~~~~~~~~~~~~~~", "8-6-2-8-0-3-4 There's only a few more!")
