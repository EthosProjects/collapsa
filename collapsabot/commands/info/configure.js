    ...
    execute: async (message, args = [], client, mLab) => {
        ...
        let validRoleFilter = (m) => {
            return (
                ...
                ((m.mentions.roles.first() && message.guild.roles.cache.has(m.mentions.roles.first().id)) ||
        ...
        let validChannelFilter = (m) => {
            return (
                m.author.id == message.author.id &&
                ((m.mentions.channels.first() && message.guild.channels.cache.has(m.mentions.channels.first().id)) ||
        ...
        switch (args[0]) {
                    ...
                    .then(async (mc) => {
                        ...
                        if (m.content == 'no') {
                            ...
                            let channel =
                                ...
                                message.guild.channels.cache.get(m.mentions.channels.first().id);
            ...
            default:
                ...
                message.channel
                    ...
                    .finally(() => {
                        message.channel
                            .awaitMessages(validChannelFilter, {
                                max: 1,
                                time: 15000,
                            })
                            .then(async (mc) => {
