...
module.exports = new Command({
    ...
    execute: async (message, args = [], client, mLab) => {
            ...
            let embed = new MessageEmbed()
                ...
                .addFields([
                    { name: 'Reason', value: reason ? reason : 'No reason specified', inline: true },
                    {
                        ...
                        value: user.guilds[guild.id].moderation.filter(warning => warning.type == 'Warning').length,
                        inline: true,
                    },
                ])
        ...
        if (authorRolesArr[0] <= memberRolesArr[0])
            return message.reply("You can't warn this user your role is not high enough");
